...
<form method="post" name="form1" action="create_vid11.php">
    <div style="float:right; margin-top:-6px;">
       <span><input type="text" name="search1" placeholder="Bed No" id="inputString" onKeyUp="lookup(this.value);" onBlur="fill();" style="width:60px;"/></span>
                <span><input type="submit" name="find1" value="Search" class="btn" style="width:60px;"/></span>
    </div>
</form>
</div>
...
<form method="post" action="search11.php" autocomplete="off">

    <div id="search_exist">
        <div id="search_txt" class="p_adding">Search Existing Patient</div>
        <div class="p_adding">
            <span><input type="text" name="search" placeholder="PID/Name/Ph/Email" id="inputStringVp" onKeyUp="lookupVp(this.value);" onBlur="fillVp();"  /></span>
...
<form method="post" action="save_bill11.php" autocomplete="off">


<div style="overflow-y:scroll; overflow-x:hidden; height:250px; padding-left:5px;">
    <div class="consult_head">
        <div class="l_ft w_idth" style="width:200px; text-align:left"><strong><a href="procedure_info.php">Procedure</a></strong></div>
	...
	<div class="l_ft" style="width:180px;"><input type="text" size="30" style="font-size:16px;" id="inputStringVpP" name="procedure" onKeyUp="lookupVpP(this.value);"
...
?>
                ...
                <div class="l_ft" style="width:150px;"><input type="text" name="amount" id="amount" style="width:100px;"/></div>
                <div class="l_ft" style="width:150px;"><input type="text" name="discount" value="0" style="width:100px;"/></div>
                <div class="l_ft" style="width:150px;"><input type="text" name="taxrate" value="0" style="width:100px;"/></div>
                <div class="l_ft" style="width:150px; text-align:center"><input type="submit" value="Add" name="add" class="btn" style="width:100px;" /></div>
                <div class="l_ft"></div>
            </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$source<br/>&nbsp;&nbsp;&nbsp;$pan&nbsp;&nbsp;&nbsp;$corp&nbsp;&nbsp;&nbsp;
$proc_name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>$proc_doc_name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</td><td>$proc_amount &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>$proc_discount &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>$proc_taxrate &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>$proc_total</td><td><a href='save_bill11.php?delete=$proc_id'>DELETE</a></td>";
                    echo "</tr>";
                }
            }
