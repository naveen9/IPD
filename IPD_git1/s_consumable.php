...
<div id="container">
    ...
    <div style="float:left">
        <span class="p_adding">Consumamble</span>
    </div>
...
<form method="post" action="s_medicine_add.php">
<div id="opd_bill">
    <span class="p_adding"><strong> <a href="add-medicine.php" style="color:#0080FF">Consumable</a>   </strong></span>
</div>
...
<div style=" background:lightgray; padding: 10px "><?php $dom=$_SESSION['dom'];
                ...
                <div style="float:left; width:180px; margin-right:5px;"><strong>Consumable Name</strong></div>
                <div style="float:left; width:80px; "><strong>Batch No</strong></div>
                <div style="float:left; width:80px; "><strong>MRP(Rs)</strong></div>
                <div style="float:left; width:80px; "><strong>Pack</strong></div>
                <div style="float:left; width:80px; "><strong>Quantity</strong></div>
                <div style="float:left; width:175px; "><strong>Exp Date</strong></div>
                <div style="float:left; width:80px;"><strong>Tax(%)</strong></div>
			...
			<input name="m_name" type="text" id="inputStringC" onKeyUp="lookupC(this.value);"  >
			<!--<input name="m_name" type="text"  >-->
			</div>
        
            <div style="float:left; width:80px; "><input type="text" name="batch_no" id="batch_no" class="jag_txt1" style="width:75px" /></div>
            <div style="float:left; width:80px; "><input type="text" name="mrp" id="mrp" class="jag_txt1"  style="width:75px" /></div>
            <div style="float:left; width:80px; "><input type="text" name="packs" id="packs" class="jag_txt1"  style="width:75px" /></div>
            <div style="float:left; width:80px; "><input type="text" name="quantity" id="quantity"  class="jag_txt1"  style="width:75px" /></div>
            <div style="float:left; width:175px; "><input type="text" name="exp_date" id="exp_date"  class="jag_txt1"/></div>
            <div style="float:left; width:80px;"><input type="text" name="tax" id="tax" class="jag_txt1"  style="width:70px" /></div>
            <div style="float:left; width:100px; text-align: center"><span>&nbsp;</span></div>
            <div style="float:left; width:80px; text-align:center;"><input type="submit" name="add" value="Add" class="btn"" />
			</div>
        
            <div class="cls" style=" margin-bottom:15px;">
			</div>
			    <div align="left" class="suggestionsBoxC" id="suggestionsC" style="display:none;">
                <div align="left" class="suggestionListC" id="autoSuggestionsListC">
				</div>
				</div>
            </div>
            <div class="cls"></div>
    ...
    while($data=mysql_fetch_array($sql))
    {
        ...
        <div style="float:left; width:80px;  text-align: center "><?php echo $data[10]; ?></div>
        <div style="float:left; width:80px;  text-align: center"><?php echo $data[11]; ?></div>
        <div style="float:left; width:175px; text-align:center;"><?php echo $data[12]; ?></div>
        <div style="float:left; width:100px;  text-align:center;"><?php echo $data[13]; ?></div>
        <div style="float:left; width:80px; text-align:center;"><span><?php echo $data[14]; ?></span></div>
        <div style="float:left; width:90px; text-align:center; "><a href="medicine_add.php?delete=<?php echo $data[0]; ?>">Delete</a></div>
