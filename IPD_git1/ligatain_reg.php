...
.ui-datepicker-calendar {
    ...
    <div style="width:100%; height:20px; padding:10px 0px; background:#CCC; font-weight:600">
        <span class="p_adding">ligatain</span>
    </div>
      <form action="ligatain.php" method="post">
      <div style="width:100%; background:#91C8FF; height:20px; padding:5px 0px;">
          ...
          <div style="float:left; width:250px; margin-right:5px;"><strong>Add</strong></div>
          ...
          <div style="float:left; width:250px; margin-right:5px;"><input type="text" name="add" value="" style="width:230px;" /></div>
          
          <div style="float:left; width:100px; margin-right:5px;"><input type="date" name="date" value="" style="width:80px;"  /></div>
          
          <div style="float:left; width:80px;  margin-left:2px;"><input type="submit" value="Add" name="lig" class="btn" /></div>
         ...
         <div class="cls"></div>
          ...
          <div style="float:left; width:250px; margin-right:5px;"><strong>Add</strong></div>
            ...
            <div style="float:left; width:100px; margin-right:5px;"><strong>Date</strong></div>
                ...
                <?php $res3=mysql_query("select * from ligatain ORDER by l_id DESC");
                  ...
                  <form method="post">
                   ...
                   <div style="float:left; width:70px; margin-right:5px;"><?php echo $row3[0];?></div>
                    ...
                    <div style="float:left; width:70px; "><?php echo $row3[3];?></div>
                      <div style="float:left; width:250px; "><?php echo $row3[4];?></div>
             ...
             {
                 $chk=$_POST['chk'];
                 mysql_query("delete from ligatain where l_id='$chk'")or die(mysql_error());
             }
             ?>
