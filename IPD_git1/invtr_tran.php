...
<form method="post">
    ...
    <div style="float:left; width:90px;"><input type="submit" name="submit1" value="Transfer" class="btn"></div>
      </div>
...
if(isset($_POST['submit1']))
             {
              ...
              $quantity2=$quantity-$quantity1;
                 ...
                 mysql_query("update inventory_store set quantity=$quantity2 where in_id='$in_id'")or die(mysql_error());
