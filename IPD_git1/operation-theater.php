...
<form method="post" action="search_operation_theater.php" autocomplete="off">
  <div id="search_exist">
...
<div align="left" class="suggestionListAd" id="autoSuggestionsListCo">
  ...
  <div id="add_new_patient"  style="float:left; width:720px;">
    ...
    <form action="#" method="post">
     	...
     	<div style="float:left; width:50px; padding-top:7px;"> Name</div>
          <div style="float:left; width:220px;"><input type="text" class="i"  value="<?php echo $_SESSION['p_name'];?>" /></div>
          <div style="float:left; width:40px; padding-top:7px;">Age</div>
          <div style="float:left; width:90px;"><input type="text" maxlength="3" class="size_box" id="txtChar" value="<?php echo $_SESSION['p_age'];?>" style="width:60px;" /></div>
         <div style="float:left; padding-top:7px;">Gender</div>
          <div style="float:left; padding-top:7px; margin-left:10px;"><input type="radio" name="gender" value="M" checked <?php if($_SESSION['p_gender']=='M'){echo "checked";} ?>/>
            <strong>M</strong>
            <input type="radio" name="gender" value="F" <?php if($_SESSION['p_gender']=='F'){echo "checked";} ?>/>
            <strong>F</strong>&nbsp;&nbsp;&nbsp;
        </div>
       <div style="float:left; padding-top:7px; ">Phone</div>
       <div style="float:left;"><input type="text" style="width:120px;" maxlength="10" class="size_input"  value="<?php echo $_SESSION['p_mob'];?>" id="txtChar" onkeypress="return validateNumbersOnly(event)" /></div>
        <div style="float:left; margin:10px 10px;">Bed No:</div>
       <div style="float:left;  margin:10px 0px;"><label id="bedno"><?php echo $_SESSION['bed_no'];?></label></div>

       <span style=" float:right;margin-right:300px;">Patient ID :
  <label for>
  ...
  <div class="cls"></div>
        ...
        <form method="post" action="ot_makepayment.php">
        ...
        <div style="width:100px; float:left;margin-left:50px;">
            <span>IP Id :</span>
            <span><label for> <?php echo $v_id=$_SESSION['v_id'];?></label></span>
        </div>
...
<div id="opd_bill" style="padding:0;">
 <div style="float:left; width:300px;">Procedures</div>
  <!--<div style="float:left; width:400px;">Surgeon Name <input type="text"  name="surgeon_name"/></div>-->
