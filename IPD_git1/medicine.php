...
if($db==0)
{
    ...
    <div id="opd_bill" style="height:20px;">
        <div style="float:left">
         ...
         <form method="post" action="madison_search1.php" autocomplete="off">
    ...
    <form method="post" action="medicine_add1.php" autocomplete="off">
        <div id="opd_bill">
        ...
        <div style="overflow-y:scroll; overflow-x:hidden; height:250px; padding-left:5px;">
            ...
            while($data=mysql_fetch_array($sql))
            {
                ...
                <div style="float:left; width:110px; text-align:center; "><a href="medicine_add1.php?delete=<?php echo $data[0]; ?>">Delete</a></div>
