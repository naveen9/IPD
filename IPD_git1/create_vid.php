...

{
    $search=$_POST['search'];
        ...
        {
            $q=mysql_query("select P.patient_id,P.p_name,P.p_age,P.p_gender,P.p_mob,V.visit_id,V.bed_no from patient_info P,visit_register V where V.bed_no='$search' and V.bed_no!='Discharge patient' and P.patient_id=V.p_id");
            ...
            else
            {
                ...
                $_SESSION['b_id']=$fet_b_id[0];
                $b_id=$_SESSION['b_id'];//storing bill id in session
                header("location: consultation.php?error_msg1=".urlencode("Patient Found"));
            }
        }
