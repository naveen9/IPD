...
<form action="s_search_ip-management.php" method="post">
...
<div style="float:right;">
    ...
    <div class="tot_amount" style="background: lightcyan; width: 100%; padding:5px 0px;">
      ...
      <label for id=""><?php echo $_SESSION['stats'] ;?></label>
      	 ...
      	 <div style="color:#0066FF;">Bed No:
             <label for id=""><?php echo $_SESSION['bed_no'] ;?></label>
      </div>
  </div>
    ...
    <div>
        <div class="cls"></div>
      <div style="padding:0px 0px 20px 0px; border-bottom:1px solid #666666; border-top:1px solid #666666;">
...
<div class="cls"></div>
    ...
    <form method="post" action="s_ip-management_add.php">
   
    <div id="opd_bill" style="background:#FFF">
        <div class="l_ft" style="margin-right:20px;"><strong>Bed Transfer</strong></div>
        <div class="l_ft" style="margin-right:20px;"><span>To Bed</span><span>
