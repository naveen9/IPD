...
header("location: requition.php?error_msg=".urlencode("Please Enter a Searchword!"));
}
else
{
...
if($found==0)
{
    ...
    unset($_SESSION['bed_no']);
    unset($_SESSION['crnt_gvn_anmt']);
header("location: requition.php?error_msg=".urlencode("Patient Not Found! Please Add the Patient!"));
}
else
{
...
header("location: requition.php?error_msg1=".urlencode("Patient Found"));
}
