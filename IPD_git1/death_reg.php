...
.ui-datepicker-calendar {
    ...
    <div style="width:100%; height:20px; padding:10px 0px; background:#CCC; font-weight:600">
        <span class="p_adding">Death Register</span>
    </div>
      ...
      <div style="width:100%; background:#91C8FF; height:20px; padding:5px 0px;">
            ...
            <div style="float:left; width:70px; margin-right:5px;"><strong>Sex</strong></div>
          <div style="float:left; width:150px; margin-right:5px;"><strong>Add</strong></div>
            ...
            <div style="float:left; width:180px; margin-right:5px;"><strong>Cause</strong></div>
            ...
            <div style="float:left; width:80px; "><input type="text" name="age" value="" style=
                    ...
                    <div style="float:left; width:70px; "><input type="text" name="sex" value="" style=
                    width:40px;"/></div>
           
          <div style="float:left; width:150px; margin-right:5px;"><input type="text" name="add" value="" style="width:130px;" /></div>
          <div style="float:left; width:100px; margin-right:5px;"><input type="date" name="date" value="" style="width:80px;"  /></div>
          <div style="float:left; width:100px; margin-right:5px;"><input type="text" name="time" value="<?php echo $time; ?>" style="width:80px;"  /></div>
          <div style="float:left; width:180px; margin-right:5px;"><input type="text" name="cause" value="" style="width:130px;" /></div>
          <div style="float:left; width:80px;  margin-left:2px;"><input type="submit" value="Add" name="death" class="btn" /></div>
         ...
         <div class="cls"></div>
          ...
          <div style="float:left; width:150px; margin-right:5px;"><strong>Add</strong></div>
            ...
            <div style="float:left; width:180px; margin-right:5px;"><strong>Cause</strong></div>
                ...
                <?php $res3=mysql_query("select * from death ORDER by d_id DESC");
                while($row3=mysql_fetch_array($res3)){  ?>
                  ...
                  <form method="post">
                   ...
                   <div style="float:left; width:70px; margin-right:5px;"><?php echo $row3[0];?></div>
                    ...
                    <div style="float:left; width:70px; "><?php echo $row3[3];?></div>
                      <div style="float:left; width:150px; "><?php echo $row3[4];?></div>
                    <div style="float:left; width:100px;"><?php echo $row3[5];?></div>
                    <div style="float:left; width:100px;"><?php echo $row3[6];?></div>
                    <div style="float:left; width:180px;"><?php echo $row3[7];?></div>
             ...
             {
                 $chk=$_POST['chk'];
                 mysql_query("delete from death where d_id='$chk'")or die(mysql_error());
             }
             ?>
