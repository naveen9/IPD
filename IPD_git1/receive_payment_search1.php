...
if($_POST['find'])
{
    if($user!=='billingadmin')
    {
        if($search=="")
        {
            header("location: receive_payment1.php?error_msg=".urlencode("Please Enter a Searchword!"));
        }
        else
        {
            ...
            if($found==0)
            {
                header("location: receive_payment1.php?error_msg=".urlencode("Patient Not Found! Please Add the Patient!"));
            }
            else
            {
...
//echo $p_id;
                ...
                header("location: receive_payment1.php?error_msg1=".urlencode("Patient Found!"));
            }
        }
    }
    else
