...
if($_POST['print_receipt'])
{
    ...
    else
    {
        ...
        if($total_due>0)
        {
            ...
            mysql_query("update opd_bill set due_amount=0 where visit_id='$v_id'");
            mysql_query("insert into opd_bill values('','NULL','$final_due_amount','$amount','$remark','paid','$mode','$trans_details','NULL','$disc_amount','$date','$time','$v_id','$proc_status','$uname')");
    ...
    echo '<META http-equiv="refresh" content="0;URL=recive_payment_discharge.php?page=ad">';
...
if($_POST['print_dis'])
{
    ...
    mysql_query("update visit_register set bed_no='Discharge patient' where p_id='$p_id'");
    //mysql_query("update room_charge set bed_no=0 where v_id ='$v_id'");
    mysql_query("insert into discharge_table values('','$p_id','$v_id','$billdate','$disc_time')");
