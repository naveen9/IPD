...
if($_POST['find'])
{
    if($user!=='billingadmin')
    {
        ...
        if($search=="")
        {
            ...
            header("location: consumable.php?error_msg=".urlencode("Please Enter a Searchword!"));
        }
        else
        {
            ...
            if($found==0)
            {
                ...
                header("location: consumable.php?error_msg=".urlencode("Patient Not Found! Please Add the Patient!"));
            }
            else
            {
...
//$_SESSION['p_email']=$search_result['p_email'];
                ...
                $b_id=$_SESSION['b_id'];
                header("location: consumable.php?error_msg1=".urlencode("Patient Found! "));
