...
.ui-datepicker-calendar {
    ...
    <div style="width:100%; height:20px; padding:10px 0px; background:#CCC; font-weight:600">
        <span class="p_adding">MLC</span>
    </div>
      <form action="mlc.php" method="post">
      <div style="width:100%; background:#91C8FF; height:20px; padding:5px 0px;">
          ...
          <div style="float:left; width:80px;  margin-left:2px;"><input type="submit" value="Add" name="mlc" class="btn" /></div>
         ...
         <div class="cls"></div>
          ...
          <div style="float:left; width:150px; margin-right:5px;"><strong>Add</strong></div>
            ...
            <div style="float:left; width:100px; margin-right:5px;"><strong>Date</strong></div>
                ...
                <?php $res3=mysql_query("select * from mlc ORDER by m_id DESC");
             ...
             {
                 $chk=$_POST['chk'];
                 mysql_query("delete from mlc where m_id='$chk'")or die(mysql_error());
             }
             ?>
