...
<form method="post" name="form1" action="create_vid11.php">
    <div id="add_new_patient">
        ...
        <div style="float:right; width:69%; margin-top:15px;">
            ...
            <div style="width:18%; float:left">
                <strong>Age&nbsp;</strong>
                <input type="text" name="age" maxlength="3" class="size_box" id="txtChar" value="<?php echo $_SESSION['p_age'];?>" style="width:40px;"/>
			</div>
...
<form method="post" action="demo.php">
                ...
                <div class="f_l">
                    ...
                    <div class="f_l">
                    	<div><input type="text" style="width:60px;" /></div>
                    </div>
                <div class="f_l">
                    	<div>Weight :</div>
                    </div>
