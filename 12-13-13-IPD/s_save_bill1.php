...
if(isset($_POST['add']))
{
    ...
    {
        header('location: s_visit_proc.php');
    }
    else
    {
        $opd=mysql_query("insert into opd_items values('','$v_id','$b_id','$procedure','$doc_incharge','$amount','$discount','$taxrate','$total','$billdate','$billtime','$proc_status','$uname')")or die(mysql_error());
        $bene=mysql_query("insert into beneficairy_payment values('','$v_id','$p_name','$b_id','$procedure','$proc_id','$doc_incharge','$total','$billdate','$deduction'
,'$share','$tds','',$remark','','')");
...
if($_REQUEST['delete'])
{
    ...
    mysql_query("delete from patient_panel where panel_id='$delete'")or die(mysql_error());
