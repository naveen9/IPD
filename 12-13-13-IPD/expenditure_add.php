...
<div style="width:100%; background:#91C8FF; height:20px; padding:5px 0px;">
            ...
            <div style="float:left; width:200px; margin-right:5px;"><strong>Expenditure Group</strong></div>
          ...
          <div style="float:left; width:100px;  margin-left:120px;"><input type="submit" value="Add" name="lig" class="btn" /></div>
</div>
</form>
<div class="cls"></div>
          ...
          <div style="width:100%; background:#91C8FF; height:20px; padding:5px 0px;">
            ...
            <div style="float:left; width:120px; margin-right:5px;"><strong>Date</strong></div>
                ...
                <?php $res3=mysql_query("select * from expenditure_table ORDER by exp_id DESC");
