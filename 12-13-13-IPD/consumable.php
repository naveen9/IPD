...
<div id="opd_bill" style="height:20px;">
    <div style="float:left">
        <span class="p_adding">Consumable</span>
    </div>
<form method="post" action="madison_search.php" autocomplete="off">
...
<div class="record_feed">
            ...
            <div id="search_exist">
                ...
                <div class="p_adding">
                    <span><input type="text" name="search" placeholder="PID/Name/Ph/Email" id="inputStringAd" onKeyUp="lookupAd(this.value);"  /></span>
...
<form method="post" action="medicine_add.php" autocomplete="off">
<div id="opd_bill">
...
<div style=" background:lightgray; padding: 10px "><?php $dom=$_SESSION['dom'];
            ...
            while($data=mysql_fetch_array($sql))
            {
                ...
                <div style="float:left; width:110px; text-align:center; "><a href="medicine_add.php?delete=<?php echo $data[0]; ?>">Delete</a></div>
