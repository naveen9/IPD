...
{
echo '<ul><li onClick="fillVp(\''.$result->patient_id.'\');">'.'<b>'.$result->patient_id.'</li>';
echo '<li onClick="fillVp(\''.$result->patient_id.'\');">'.'<b>'.$result->p_name.'</li>';
echo '<li onClick="fillVp(\''.$result->patient_id.'\');">'.'<b>'.$result->p_mob.'</li>';
echo '<li onClick="fillVp(\''.$result->patient_id.'\');">'.'<b>'.$result->p_email.'</li></ul>';
