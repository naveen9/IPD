...
<div style="line-height:20px; padding:5px; border-bottom:1px solid lightgray;">
    ...
    <div style="width:25%; float:left;"><strong><a href="expenditure_add.php">Expenditure Group</a></strong></div>
...
<div style="line-height:20px; padding:5px; border-bottom:1px solid lightgray;">
    ...
    <div style="width:20%; float:left;">
    	 <span>
            	<select id="select_size" name="expenditure_name">
				<?php $docQuery=mysql_query("select * from  expenditure_table");
	   
	                     while($docValues=mysql_fetch_array($docQuery))
                {
                                 ?>
                      <option value="<?php echo $docValues['exp_id']; ?>"><?php echo $docValues['exp_name']; ?></option>
                      <?php } ?>
    ...
    <div style="width:19%; float:left; text-align:right;"><input type="submit" value="Add" class="btn" name="sub_add"></div>
          <div class="cls"></div>
    </form>
</div>
                <form method="post">
<div id="opd_bill">
	...
	<div style="width:12%; float:left;"><strong>Financial Year :</strong></div>
    <div style="width:30%; float:left;"><span id="f_date"></span>&nbsp;-&nbsp;<span id="e_date"></span></div>
    <div style="width:25%; float:left;"><strong>Total : </strong></div>
     <div style="width:28%; float:left;"><strong>Month  &nbsp;&nbsp;&nbsp;<input name="monthDate" id="startDate" class="date-picker" style=" border-radius:6px; height:20px; border:1px solid lightgray;" />  &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;</strong></div>
     <div style="width:3%; float:left; text-align:center"><input type="submit" value="Show" name="show12" class="btn"></div>
     <div class="cls"></div>
    </div> 
</div>
...
<div style="line-height:20px; padding:5px; border-bottom:1px solid lightgray;">
    <?php
         ...
         $select21=("select G.s_no,G.details,G.amount,G.date,T.exp_name from expenditure_group G,expenditure_table T where G.exp_group_id=T.exp_id ORDER BY G.s_no DESC ");
