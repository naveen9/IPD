...
$padd_date=$_SESSION['patient_visit_date'];
...
$pdf->cell(3.9, -1, "Admit Date:    $padd_date", 0, 1, 'R');
$pdf->cell(6.8, 1.0, "Receipt No.:    $reciept_id", 0, 1, 'R');
$pdf->SetFont('Arial','',12);
//$pdf->cell(7, 0.2, "----------------------------------------------------------------------------------------------------------------------------------", 0, 1, 'C');
$pdf->ln(-.3);
$pdf->SetFont('Arial','B',10);
$pdf->cell(0, 1.0, "Advance Amount(Rs): $paid_amount", 1, 1, 'L');
$pdf->SetFont('Arial','B',10);
$pdf->cell(4.5, -1.0, "Payment Mode:    $payment_mode", 0, 1, 'R');
$pdf->cell(7, 1.0, "Date:    $padd_date ", 0, 1, 'R');
$pdf->ln(.6);
$pdf->SetFont('Arial','',12);
