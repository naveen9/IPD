<div id="menuu">
   <ul id="coolMenu1">
	    <li><a href="http://localhost/office_work/ashutosh/avantikanew/dashboard.php">Home</a></li>
        <li><a href="#">OPD Billing</a>
         <ul>
            <li><a href="appointment-list.html">List of Appointments</a></li>
            <li><a href="http://localhost/office_work/ashutosh/avantikanew/consultation.php">Consultation/Procedure</a></li>
       ...
       <ul>
        ...
        <li><a href="index.php">Data Management</a>
