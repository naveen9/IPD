...
{
echo '<ul><li onClick="fillDi(\''.$result->patient_id.'\');">'.'<b>'.$result->patient_id.'</li>';
echo '<li onClick="fillDi(\''.$result->patient_id.'\');">'.'<b>'.$result->p_name.'</li>';
echo '<li onClick="fillDi(\''.$result->patient_id.'\');">'.'<b>'.$result->p_mob.'</li>';
echo '<li onClick="fillDi(\''.$result->patient_id.'\');">'.'<b>'.$result->p_email.'</li></ul>';
